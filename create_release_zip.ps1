...
$release_foldername = "DroneBridge_ESP32_v2_4_1_stable"
$release_name_zip = "DroneBridge_ESP32_v2_4_1_stable.zip"
...
# ESP32
BuildAndCopy "sdkconfig.defaults.esp32" "esp32" "esp32"
# BuildAndCopy "sdkconfig_esp32_noUARTConsole" "esp32_noUARTConsole" # Build issue - ESP-NOW wants a console for debugging

# ESP32-S2
BuildAndCopy "sdkconfig.defaults" "esp32s2" "esp32s2"
BuildAndCopy "sdkconfig.defaults.noUARTConsole" "esp32s2_noUARTConsole" "esp32s2"

# ESP32-S3
BuildAndCopy "sdkconfig.defaults" "esp32s3" "esp32s3"
BuildAndCopy "sdkconfig.defaults.noUARTConsole" "esp32s3_noUARTConsole" "esp32s3"
BuildAndCopy "sdkconfig.defaults.USBSerial" "esp32s3_USBSerial" "esp32s3"

# ESP32-C3 Official
BuildAndCopy "sdkconfig.defaults.official.esp32c3" "esp32c3_official" "esp32c3"
BuildAndCopy "sdkconfig.defaults.official.USBSerial.esp32c3" "esp32c3_official_USBSerial" "esp32c3"
BuildAndCopy "sdkconfig.defaults.official.noUARTConsole.esp32c3" "esp32c3_official_noUARTConsole" "esp32c3"

# ESP32-C3 Generic
BuildAndCopy "sdkconfig.defaults" "esp32c3" "esp32c3"
BuildAndCopy "sdkconfig.defaults.USBSerial" "esp32c3_USBSerial" "esp32c3"
BuildAndCopy "sdkconfig.defaults.noUARTConsole" "esp32c3_noUARTConsole" "esp32c3"

# ESP32-C6 Official
BuildAndCopy "sdkconfig.defaults.official.esp32c6" "esp32c6_official" "esp32c6"
BuildAndCopy "sdkconfig.defaults.official.USBSerial.esp32c6" "esp32c6_official_USBSerial" "esp32c6"
BuildAndCopy "sdkconfig.defaults.official.noUARTConsole.esp32c6" "esp32c6_official_noUARTConsole" "esp32c6"

# ESP32-C6 Generic
BuildAndCopy "sdkconfig.defaults" "esp32c6" "esp32c6"
